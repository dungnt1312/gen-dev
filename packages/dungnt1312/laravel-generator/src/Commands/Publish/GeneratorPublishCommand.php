...
class GeneratorPublishCommand extends PublishBaseCommand
{
    ...
    private function fillTemplate($templateData)
    {
        ...
        $namespaceController = config('infyom.laravel_generator.namespace.controller', 'App\Http\Controllers');
        ...
        $templateData = str_replace('$NAMESPACE_CONTROLLER$', $namespaceController, $templateData);
